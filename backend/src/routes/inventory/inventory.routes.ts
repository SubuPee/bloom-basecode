 ...
 */
router.post("/stock/add", addInboundStock);
 ...
 */
router.post("/stock/adjust", adjustInventoryStock);
 ...
 */
router.get("/stock/adjust", adjustmentHistory);
