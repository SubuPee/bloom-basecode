 ...
 */
router.get("/", protect, authorize("orders.read"), orderController.getOrders);
 ...
 *         description: Authentication required
 */
router.get("/stats", protect, authorize("orders.read"), orderController.getOrderStats);
 ...
 *         description: Authentication required
 */
router.get("/export", protect, authorize("orders.read"), orderController.exportOrders);
 ...
 */
router.post("/bulk/status", protect, authorize("orders.update"), orderController.bulkUpdateStatus);
 ...
 */
router.post("/", protect, authorize("orders.create"), orderController.createOrder);
 ...
 */
router.get("/:id", protect, authorize("orders.read"), orderController.getOrderById);
 ...
 *         description: Order not found
 */
router.patch("/:id/status", protect, authorize("orders.update"), orderController.updateOrderStatus);
 ...
 *         description: Order not found
 */
router.patch("/:id/payment", protect, authorize("orders.update"), orderController.updatePaymentStatus);
 ...
 *         description: Order not found
 */
router.get("/:id/invoice", protect, authorize("orders.read"), orderController.getOrderInvoice);
 ...
 *         description: Order not found
 */
router.delete("/:id", protect, authorize("orders.delete"), orderController.deleteOrder);
