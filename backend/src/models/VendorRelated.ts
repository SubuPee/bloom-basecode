...
export const VendorOrder: Model<any> =
  mongoose.models.VendorOrder || mongoose.model("VendorOrder", vendorOrderSchema);

export const VendorSettlement: Model<any> =
  mongoose.models.VendorSettlement || mongoose.model("VendorSettlement", vendorSettlementSchema);

export const VendorPayment: Model<any> =
  mongoose.models.VendorPayment || mongoose.model("VendorPayment", vendorPaymentSchema);

export const VendorReturn: Model<any> =
  mongoose.models.VendorReturn || mongoose.model("VendorReturn", vendorReturnSchema);

export const VendorTransaction: Model<any> =
  mongoose.models.VendorTransaction || mongoose.model("VendorTransaction", vendorTransactionSchema);

export const VendorActivityLog: Model<any> =
  mongoose.models.VendorActivityLog || mongoose.model("VendorActivityLog", vendorActivityLogSchema);
