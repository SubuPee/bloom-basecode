...
const production_controller_1 = require("../../controllers/production/production.controller");
/**
 * @swagger
 * tags:
 *   name: Production
 ...
 */
router.get("/overview", production_controller_1.overview);
/**
 * @swagger
 ...
 */
router.get("/history", production_controller_1.history);
/**
 * @swagger
 ...
 */
router.get("/orders", production_controller_1.listOrders);
/**
 * @swagger
 * /api/production/orders:
 *   post:
 ...
 */
router.post("/orders", production_controller_1.create);
/**
 * @swagger
 ...
 */
router.get("/orders/:id", production_controller_1.getOrder);
/**
 * @swagger
 ...
 */
router.patch("/orders/:id/start", production_controller_1.start);
/**
 * @swagger
 ...
 */
router.patch("/orders/:id/complete", production_controller_1.complete);
/**
 * @swagger
 ...
 */
router.patch("/orders/:id/cancel", production_controller_1.cancel);
