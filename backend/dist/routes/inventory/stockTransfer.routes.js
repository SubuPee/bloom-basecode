...
const stockTransfer_controller_1 = require("../../controllers/inventory/stockTransfer.controller");
/**
 * @swagger
 * tags:
 ...
 */
router.post("/transfers", stockTransfer_controller_1.initTransfer);
/**
 * @swagger
 * /api/inventory/transfers:
 *   get:
 ...
 */
router.get("/transfers", stockTransfer_controller_1.listTransfers);
/**
 * @swagger
 ...
 */
router.patch("/transfers/:id/receive", stockTransfer_controller_1.confirmReceive);
/**
 * @swagger
 ...
 *         description: Transfer not found
 */
router.patch("/transfers/:id/cancel", stockTransfer_controller_1.cancelTransferHandler);
exports.default = router;
//# sourceMappingURL=stockTransfer.routes.js.map