 ...
 */
router.get("/stats", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.read"), cms_controller_1.getCmsStatsHandler);
/**
 * @swagger
 * /api/cms/hero:
 *   get:
 ...
 */
router.get("/hero", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.read"), cms_controller_1.getStorefrontHeroHandler);
/**
 * @swagger
 * /api/cms:
 *   get:
 ...
 *         description: Unauthorized
 */
router.get("/", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.read"), cms_controller_1.getCmsEntriesHandler);
/**
 * @swagger
 * /api/cms:
 *   post:
 ...
 */
router.post("/", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.create"), cms_controller_1.createCmsEntryHandler);
/**
 * @swagger
 * /api/cms/{id}:
 *   get:
 ...
 */
router.get("/:id", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.read"), cms_controller_1.getCmsEntryByIdHandler);
/**
 * @swagger
 * /api/cms/{id}:
 *   put:
 ...
 *         description: CMS entry not found
 */
router.put("/:id", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.update"), cms_controller_1.updateCmsEntryHandler);
/**
 * @swagger
 * /api/cms/{id}:
 *   delete:
 ...
 *         description: CMS entry not found
 */
router.delete("/:id", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("cms.delete"), cms_controller_1.deleteCmsEntryHandler);
