 ...
 */
router.get("/overview", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getSalesOverview);
router.get("/", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getSalesOverview);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/metrics", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getSalesMetrics);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/chart", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getSalesChart);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/channels", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getSalesChannels);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/top-products", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getTopProducts);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/customer-mix", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getCustomerMix);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/transactions", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.getSalesTransactions);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.get("/export", authMiddleware_1.protect, (0, permissionMiddleware_1.default)("sales.read"), sales_controller_1.default.exportSalesReport);
